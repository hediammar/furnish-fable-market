      ...
      <div className="container-custom relative z-10 h-full flex flex-col justify-center text-white">
        <div className="max-w-2xl animate-fade-in">
          ...
          <p className="text-lg md:text-xl mb-8 text-white/90 max-w-xl">
            Discover our collection of meticulously crafted furniture that combines aesthetics, comfort, and functionality.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link to="/category/living-room" className="bg-white text-furniture-brown hover:bg-furniture-taupe hover:text-white font-medium px-8 py-3 rounded-md transition-colors duration-300 flex items-center">
